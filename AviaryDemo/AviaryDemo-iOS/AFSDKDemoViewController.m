...
{
    // Set Tool Order
    NSArray * toolOrder = @[kAFEffects, kAFFocus, kAFFrames, kAFStickers, kAFEnhance, kAFOrientation, kAFCrop, kAFBrightness, kAFContrast, kAFSaturation, kAFSharpness, kAFDraw, kAFText, kAFRedeye, kAFWhiten, kAFBlemish, kAFMeme, kAFWarmth];
...
- (void)setupView
{
    ...
    [previewView setImage:[UIImage imageNamed:@"Demo.png"]];
...
-(IBAction)email:(id)sender {
    // Email Subject
    NSString *emailTitle = @"Look at my picture!";
    // Email Content
...
-(IBAction)message:(id)sender {
	...
	{
		controller.body = @"Do you like my picture?";
